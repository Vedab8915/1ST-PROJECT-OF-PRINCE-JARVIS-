...
TOOL = {
    ...
    "description": "Manages PC files and folders. Use to create files/folders, write content, list, read, find, move, copy, rename, delete, inspect file details, or check disk usage.",
    "parameters": {
        "type": "OBJECT",
        "properties": {
            "action": {
